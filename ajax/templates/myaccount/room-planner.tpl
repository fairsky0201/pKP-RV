...
<div id="shoppingCartHolder" style="position:fixed; right:500px; font-size:12px; top:0px; border:0px; color:#fff; font-weight:bold; padding:2px; cursor:pointer;" align="center" onclick="showShoppingCart()">Cart (<span id="scCounter" style="color:#A06F0F">0</span>) Items <img src="images/shoopingCart.png" height="15" /></div>



<div id="bottomToolbar" style="position:fixed; left:0px; top:28px; width:200px; background:#000000; padding:5px; border-right:1px solid #333333" align="left">
	...
	<div style="overflow:hidden">
		...
		<a href="{{$smarty.const.WEBSITE_URL}}products-list.html" target="_blank" class="btnRed">Shelve Listing</a>
...
<div id="bottomToolbarInit" style="position:fixed; left:0px; top:36px; width:200px; background:#000000; padding:5px; border-right:1px solid #333333" align="center">
	...
	*}}
	...
	<style>
		...
		background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #F53D3E), color-stop(1, #F53D3E) );



		background:-moz-linear-gradient( center top, #F53D3E 5%, #F53D3E 100% );



		filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#F53D3E', endColorstr='#F53D3E');
