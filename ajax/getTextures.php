<?php
	...
	$list = new DbList('select t.* from textures as t, units as u, unit_variations as uv where u.IdManufacturer="'.$_POST['m'].'" and uv.IdCarcass="'.$_POST['c'].'" and uv.IdDoor="'.$_POST['d'].'" and uv.IdTexture=t.Id and uv.IdUnit=u.Id group by t.Id order by t.Name ASC');
	$smarty->assign('items',$list->GetCollection());
	
	$smarty->display('getTextures.tpl');
