    ...
    $.fn.makeAsyncUploader = function(options) {
        ...
        return this.each(function() {
            ...
            var defaults = {
                ...
                file_types_description: "Toate fisierele",
                ...
                button_text: "<font face='Arial' size='13pt'>Alege poza</span>",

                button_text_left_padding: (width - 70) / 2,

                button_text_top_padding: 1,
				upload_complete: function() { alert('baubau'); },
                ...
                file_queue_error_handler: function(file, code, msg) { alert("Nu a fost uploadata: " + msg); },



                // Called when an error occurs during upload

                upload_error_handler: function(file, code, msg) { alert("Nu a fost uploadata: " + msg); },
...

				{
					...
					//daca am raspuns atunci acesta este numele dat de mine fisierului
...

					{
						...
						$("input[name$=_filename]", container).val(response);

                    //$("input[name$=_guid]", container).val(response);

                    $("span[id$=_completedMessage]", container).html("Loaded <b>{0}</b> ({1} KB)"
