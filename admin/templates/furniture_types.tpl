...
<h1>Furniture types <input type="button" value="Add" onclick="modifyItem(0)" /></h1>
...
<tr bgcolor="{{cycle values='#EEE,#CCC'}}">
	<td>{{$n.Id}}</td>
	<td><img src="{{$config.siteurl}}uploads/manufacturers/{{$n.Logo}}" /></td>
...
<tr>
	<td nowrap="nowrap"><strong>Has styles:</strong></td>
	<td ><input type="radio" name="HasStyles" value="1" /> Yes <input type="radio" name="HasStyles" value="0" /> No </td>
</tr>
<tr>
...
<table width="100%" cellpadding="5" cellspacing="1">
<tr>
    <td rowspan="2"><img src="{{$config.siteurl}}uploads/manufacturers/{{$n.Logo}}" style="margin:2px; box-shadow:2px 2px 2px #000000; padding:2px; background:#FFFFFF" /></td>
	<td nowrap="nowrap"><strong>Name:</strong></td>
	<td width="100%"><input type="text" name="Name" value="{{$n.Name}}" /></td>
</tr>
<tr>
	<td nowrap="nowrap"><strong>Has styles:</strong></td>
	<td ><input type="radio" name="HasStyles" value="1"{{if $n.HasStyles==1}} checked{{/if}} /> Yes <input type="radio" name="HasStyles" value="0"{{if $n.HasStyles!=1}} checked{{/if}} /> No </td>
</tr>
<tr>
    <td nowrap="nowrap"><strong>Logo:</strong></td>
    <td><input type="file" name="Logo" value="" /></td>
...
<tr>
	<td align="center" colspan="3"><input type="submit" value="Save" /> <input type="button" value="Cancel" onclick="showItemListing()" /></td>
</tr>
</table>
</form>
</fieldset>
