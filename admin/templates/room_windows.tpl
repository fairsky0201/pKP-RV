...
<h1>Room windows <input type="button" value="Add" onclick="modifyItem(0)" /></h1>
...
<fieldset style="margin-bottom:5px">
<legend><strong>Window variations:</strong></legend>
...
<div id="innerItemsHolder{{$n.Id}}">
    ...
    <table width="100%" cellpadding="5" cellspacing="1"style="border-bottom:1px dashed #999999; background:#EFEFEF; margin-bottom:2px">
    <tr>
    	<td rowspan="3"><img src="{{$config.siteurl}}uploads/window_variation/{{$p.Picture}}" style="margin:2px; box-shadow:2px 2px 2px #000000; padding:2px; background:#FFFFFF" /></td>
        <td nowrap="nowrap"><strong>Name:</strong></td>
