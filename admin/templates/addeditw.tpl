<script language="javascript">
    ...
    (
        ...
        function()
        {
            ...
            (
                {
                    upload_url      : "../ajax/window/upload_pic2.php",
    ...
    {
        $("#DlgAddWindow").dialog({autoOpen: false, height: 420, width:750, modal: true});
        $("#DlgAddWindow").dialog('open');
    }
    function ShowAddPictureDialog2()
    {
        ...
        (
            {
                upload_url      : "../ajax/window/upload_pic.php",
                flash_url       : 'flash/swfupload.swf',
                button_image_url: 'images/blankButton.png',
                button_text     : "Upload picture",
                upload_complete : function()
    ...
    function add_pic( img, id, name )
    {
        ...
        //
        $(div).find("#ImgPoza"   ).attr("src","../uploads/window_variation/" + img);
    ...
    function ok()
    {
        ...
        if( cmd == "add" )
        {
            ...
            (
                ...
                {
                    current_id = data;
					window.location = 'index.php?page=addeditw&cmd=edit&id='+current_id;
					/*
                    $("#ImgLoading").hide();
...
<div id="DlgAddWindow" style="display:none">
    <table style="width:100%">
            <tr>
                <td>Picture poster:</td>
                <td> <input type="file"  class="variation" id="AddWindowPicturePoster" /></td>
            </tr>
            <tr>
                <td>Picture 0&deg;:</td>
                <td> <input type="file"  class="variation" id="AddWindowPicture1" /></td>
            </tr>
            <tr>
                <td>Picture 90&deg;:</td>
                <td> <input type="file"  class="variation" id="AddWindowPicture2" /></td>
            </tr>
            <tr>
                <td>Picture 180&deg;:</td>
                <td> <input type="file" class="variation"  id="AddWindowPicture3" /></td>
            </tr>
            <tr>
                <td>Picture 270&deg;:</td>
                <td> <input type="file"  class="variation" id="AddWindowPicture4" /></td>
            </tr>
            <tr>
                <td>Name:</td>
                <td><input type="text" id="TxtWindowName" style="width:150px" value="" /></td>
            </tr>
            <tr>
                <td colspan="2" align="center" valign="bottom" height="100">
                    <input type="button" value="Cancel" class="ui-widget-header ui-corner-all" style="width:100px" onclick="$('#DlgAddWindow').dialog('close');" />
...
function ok_add()
    {
        ...
        name = $("#TxtWindowName").val();
        imgp = $("[name='AddWindowPicturePoster_filename']").val();
        img1 = $("[name='AddWindowPicture1_filename']").val();
        img2 = $("[name='AddWindowPicture2_filename']").val();
        img3 = $("[name='AddWindowPicture3_filename']").val();
        img4 = $("[name='AddWindowPicture4_filename']").val();
        $.post
        (
            "ajax/window/add_window.php",
            {
                "imgp"       : imgp,
                "img0"       : img1,
                "img1"       : img2,
            ...
            <tr>
                <td height="150" colspan="2" align="center">
                    <div class="ui-state-highlight ui-corner-all" style="height:150px; overflow:hidden">
                        <img id="ImgPoza" src="../uploads/window_variation/20100611112825_.jpg" border="0"/>
                    </div>
                </td>
            </tr>
            <tr>
